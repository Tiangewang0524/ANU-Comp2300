...
binary_to_huffman:
	   load bit1 R0
	   jumpz R0 huffman_code_0
	   jumpnz R0 huffman_code_1
huffman_code_0:
	   load bit2 R0
	   jumpz R0 huffman_code_00
	   sub R0 #1 R1
	   jumpz R1 huffman_code_01
huffman_code_1:
	   load bit2 R0
	   jumpz R0 huffman_code_10
	   sub R0 #1 R1
...
huffman_code_10:
	   load bit3 R0
	   jumpz R0 huffman_code_100
	   sub R0 #1 R1
	   jumpz R1 huffman_code_101
huffman_code_11:
	   load bit3 R0
	   jumpz R0 huffman_code_110
	   sub R0 #1 R1
